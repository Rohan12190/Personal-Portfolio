...
const About = () => {
  ...
  - Exploring algorithms and data structures to write more efficient, robust code.
  - Finding patterns in data and how analytics can shape a better user experience.`;
    ...
    <section id="about" className="min-h-screen bg-black rounded-b-4xl">
      ...
      <div className="flex flex-col items-center justify-between gap-16 px-10 pb-16 text-xl font-light tracking-wide lg:flex-row md:text-2xl lg:text-3xl text-white/60">
        <img
          ...
          src="images/man.jpg"
          alt="man"
          className="w-md rounded-3xl grayscale"
        />
